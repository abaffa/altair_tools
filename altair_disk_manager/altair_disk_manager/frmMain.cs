...
namespace altair_disk_manager
{
    public partial class frmMain : Form
    {
        ...
        void cmd_ls()
        {
            ...
            foreach (FileEntry f in diskImage2.cmd_ls())
            {
                int num = f._size;
                String size = "";
            ...
            if (diskImage2.GetDisk() != null)
                statusCount.Text = diskImage2.GetDisk().type + ": ";
        ...
        private void listView1_DoubleClick(object sender, EventArgs e)
        {
            if (listView1.SelectedItems.Count == 1)
            {
                ...
                byte[] data = diskImage2.GetFile((string)listView1.SelectedItems[0].Text);
                ...
                if (frmedit.getSaveKeyHit() || (!Utils.CompareByteArrays(data, newdata) && MessageBox.Show("Save file " + listView1.SelectedItems[0].Text + "?", "Confirm save", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes))
                {
                    ...
                    diskImage2.cmd_rmdir((string)listView1.SelectedItems[0].Text);
        ...
        void refreshIconView()
        {
            ...
            Bitmap[] i = {
                global::altair_disk_manager.Properties.Resources.icoLargeIcon,
                global::altair_disk_manager.Properties.Resources.icoDetails,
            //    global::altair_disk_manager.Properties.Resources.ico62999,
                global::altair_disk_manager.Properties.Resources.icoSmallIcon,

                global::altair_disk_manager.Properties.Resources.icoList,
                global::altair_disk_manager.Properties.Resources.icoTile };
        ...
        */
        ...
        {
            if (diskImage2.cmd_rename(filename, newname))
            {
        ...
        private void listView1_AfterLabelEdit(object sender, LabelEditEventArgs e)
        {
            if (e.Label != null)
            {
                ...
                e.CancelEdit = !cmd_rename((string)listView1.Items[e.Item].Text, e.Label, e);
                e.CancelEdit = true;
            }
        ...
        private void deleteToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (listView1.SelectedItems.Count == 1)
            {
                ...
                if (dialogResult == DialogResult.Yes)
                    ...
                    cmd_rmdir((string)listView1.SelectedItems[0].Text);
            }
        ...
        private void listView1_ItemSelectionChanged(object sender, ListViewItemSelectionChangedEventArgs e)
        {
            ...
            if (itemCount == 1)
            {
                ...
                List<FileEntry> fileEntries = diskImage2.GetFileEntry((string)listView1.SelectedItems[0].Tag);
            ...
            if (current_filename != "")
            {
                if (MessageBox.Show("Save file?", "Confirm save", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    if (saveImageFile(current_filename))
                        this.Text = "Altair Disk Manager " + current_filename;
                    else
                    {
                        current_filename = "";
                        //this.Text = "Altair Disk Manager (No File)";
        ...
        private bool saveImageFile(string fileName)
        {
            ...
            return diskImage2.SaveImageFile(fileName, toolStripProgressBar1);
        }
        ...
        private void copyToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            foreach (ListViewItem item in listView1.SelectedItems)
            {
                ...
                clipboard.Add(filename, diskImage2.GetFile((string)item.Text));
            }
        ...
        private void renToUppercaseToolStripMenuItem_Click(object sender, EventArgs e)
        {
            foreach (ListViewItem item in listView1.SelectedItems)
            {
                ...
                diskImage2.cmd_rename(item.Text.ToString(), filename);
            }
            cmd_ls();
        }
